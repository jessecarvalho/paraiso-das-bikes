<template>
    <footer>
        <div class="row">
            <div class="col">
                <div>
                    <img src="@/assets/logo.png" alt="Paraíso das Bikes" id="logo-footer">
                </div>
            </div>
            <div class="col">
                <div>
        ...
        <!--              </a>-->
            ...
            <div class="col">
                <div>
                    <h2>Contato</h2>
                    <a href="https://wa.me/5511952973759" target="_blank">
                        <p>(11) 95297-3759</p>
                    </a>
                    <div class="social-media">
                        <a href="https://www.instagram.com/paraisodasbikesgru/" target="_blank">
